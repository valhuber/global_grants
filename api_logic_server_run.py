...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.03.09, September 28, 2023 10:37:27):
...
app_logger.info(f'Created September 28, 2023 10:37:27 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 09.03.09\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 09.03.09\n'
    msg += f'.. startup message: {start_up_message}\n'
